...
public record RSApplicationCancelled(UUID eventId, LocalDateTime eventTime, TripId tripId,RSApplicationId applicationId)implements DomainEvent{
    
    public RSApplicationCancelled(TripId tripId,RSApplicationId applicationId) {
