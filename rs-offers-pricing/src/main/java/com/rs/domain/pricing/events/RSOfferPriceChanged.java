...
public record RSOfferPriceChanged(UUID eventId, LocalDateTime eventTime, RSOfferId rsOfferId, double price) implements DomainEvent {
    public RSOfferPriceChanged(RSOfferId rsOfferId, double price){
